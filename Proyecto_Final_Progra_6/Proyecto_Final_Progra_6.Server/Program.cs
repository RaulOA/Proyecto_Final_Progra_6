...
using Proyecto_Final_Progra_6.Server.Authorization;
using Proyecto_Final_Progra_6.Server.Authorization.Requirements;
using Proyecto_Final_Progra_6.Server.Configuration;
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.DocumentTitle = "Swagger UI - Proyecto_Final_Progra_6";
